package com.assignment.newsapp.news.ui.adapter
...
import com.assignment.newsapp.core.utils.inflate
import com.assignment.newsapp.databinding.RowNewsArticleBinding
import com.assignment.newsapp.news.storage.entity.NewsArticleDb
import com.assignment.newsapp.news.ui.model.NewsAdapterEvent
...
class NewsArticlesAdapter(
    ...
    class NewsHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
         ...
         */
        fun bind(newsArticle: NewsArticleDb, listener: (NewsAdapterEvent) -> Unit) =
            with(itemView) {
